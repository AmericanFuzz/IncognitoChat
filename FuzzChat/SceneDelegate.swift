...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidDisconnect(_ scene: UIScene) {
        func submitBackgroundTasks() {
            ...
            let backgroundAppRefreshTaskSchedulerIdentifier = "com.TeymurKazakov.refresh"
  

            do {
              let backgroundAppRefreshTaskRequest = BGAppRefreshTaskRequest(identifier: backgroundAppRefreshTaskSchedulerIdentifier)
              backgroundAppRefreshTaskRequest.earliestBeginDate = Date(timeIntervalSinceNow: 1)
